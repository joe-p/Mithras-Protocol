...
/**
 * The argument types for the MithrasLogger contract
 */
export type MithrasLoggerArgs = {
  /**
...
/**
 * Defines the types of available calls and state of the MithrasLogger smart contract.
 */
export type MithrasLoggerTypes = {
  /**
 ...
 */
export type MithrasLoggerSignatures = keyof MithrasLoggerTypes['methods']
/**
...
>
/**
 * Maps a method signature from the MithrasLogger smart contract to the method's arguments in either tuple or struct form
 */
export type MethodArgs<TSignature extends MithrasLoggerSignatures> = MithrasLoggerTypes['methods'][TSignature]['argsObj' | 'argsTuple']
/**
 * Maps a method signature from the MithrasLogger smart contract to the method's return type
 */
export type MethodReturn<TSignature extends MithrasLoggerSignatures> = MithrasLoggerTypes['methods'][TSignature]['returns']


/**
 * Defines supported create method params for this smart contract
 */
export type MithrasLoggerCreateCallParams =
  | Expand<AppClientBareCallParams & {method?: never} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
/**
 * Defines arguments required for the deploy method.
 */
export type MithrasLoggerDeployParams = Expand<Omit<AppFactoryDeployParams, 'createParams' | 'updateParams' | 'deleteParams'> & {
  /**
   * Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)
   */
  createParams?: MithrasLoggerCreateCallParams
}>


/**
 * Exposes methods for constructing `AppClient` params objects for ABI calls to the MithrasLogger smart contract
 */
...
/**
 * A factory to create and deploy one or more instance of the MithrasLogger smart contract and to create one or more app clients to interact with those (or other) app instances
 */
export class MithrasLoggerFactory {
  /**
  ...
  /**
   * Creates a new instance of `MithrasLoggerFactory`
   *
  ...
  public getAppClientById(params: AppFactoryAppClientParams) {
    return new MithrasLoggerClient(this.appFactory.getAppClientById(params))
  }
  ...
  public async getAppClientByCreatorAndName(
    ...
    return new MithrasLoggerClient(await this.appFactory.getAppClientByCreatorAndName(params))
  }

  /**
   * Idempotently deploys the MithrasLogger smart contract.
   *
   * @param params The arguments for the contract calls and any additional parameters for the call
   * @returns The deployment result
   */
  public async deploy(params: MithrasLoggerDeployParams = {}) {
    const result = await this.appFactory.deploy({
      ...params,
    })
    return { result: result.result, appClient: new MithrasLoggerClient(result.appClient) }
  }
  ...
  readonly params = {
    ...
    create: {
      /**
       * Creates a new instance of the MithrasLogger smart contract using a bare call.
       *
...
/**
 * A client to make calls to the MithrasLogger smart contract
 */
export class MithrasLoggerClient {
  /**
  ...
  /**
   * Creates a new instance of `MithrasLoggerClient`
   *
   * @param appClient An `AppClient` instance which has been created with the MithrasLogger app spec
   */
  ...
  /**
   * Returns a new `MithrasLoggerClient` client, resolving the app by creator address and name
   * using AlgoKit app deployment semantics (i.e. looking for the app creation transaction note).
   * @param params The parameters to create the app client
   */
  public static async fromCreatorAndName(params: Omit<ResolveAppClientByCreatorAndName, 'appSpec'>): Promise<MithrasLoggerClient> {
    return new MithrasLoggerClient(await _AppClient.fromCreatorAndName({...params, appSpec: APP_SPEC}))
  }
  
  /**
   * Returns an `MithrasLoggerClient` instance for the current network based on
  ...
  ): Promise<MithrasLoggerClient> {
    return new MithrasLoggerClient(await _AppClient.fromNetwork({...params, appSpec: APP_SPEC}))
  }
  ...
  public clone(params: CloneAppClientParams) {
    return new MithrasLoggerClient(this.appClient.clone(params))
  }

  /**
   * Methods to access state for the current MithrasLogger app
   */
  state = {
  }

  public newGroup(): MithrasLoggerComposer {
    const client = this
    ...
    return {
      ...
      /**
       * Add a clear state call to the MithrasLogger contract
       */
    ...
    } as unknown as MithrasLoggerComposer
  }
}
export type MithrasLoggerComposer<TReturns extends [...any[]] = []> = {
   ...
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  clearState(params?: AppClientBareCallParams): MithrasLoggerComposer<[...TReturns, undefined]>
   ...
   */
  addTransaction(txn: Transaction, signer?: TransactionSigner): MithrasLoggerComposer<TReturns>
  /**
   ...
   */
  simulate(): Promise<MithrasLoggerComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<MithrasLoggerComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<MithrasLoggerComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
   * Sends the transaction group to the network and returns the results
   */
  send(params?: SendParams): Promise<MithrasLoggerComposerResults<TReturns>>
}
export type MithrasLoggerComposerResults<TReturns extends [...any[]]> = Expand<SendAtomicTransactionComposerResults & {
  returns: TReturns
}>
