...
export function generateCircomProof(
  ...
  return FfiConverterTypeCircomProofResult.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_mithras_mobile_fn_func_generate_circom_proof(
...
export function generateHalo2Proof(
  ...
  return FfiConverterTypeHalo2ProofResult.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_mithras_mobile_fn_func_generate_halo2_proof(
...
export function generateNoirProof(
  ...
  return FfiConverterArrayBuffer.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_mithras_mobile_fn_func_generate_noir_proof(
...
export function getNoirVerificationKey(
  ...
  return FfiConverterArrayBuffer.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_mithras_mobile_fn_func_get_noir_verification_key(
          FfiConverterString.lower(circuitPath),
          FfiConverterOptionalString.lower(srsPath),
          FfiConverterBool.lower(onChain),
          FfiConverterBool.lower(lowMemoryMode),
...
export function moproHelloWorld(): string {
  return FfiConverterString.lift(
    uniffiCaller.rustCall(
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_mithras_mobile_fn_func_mopro_hello_world(
          callStatus
        );
      },
      /*liftString:*/ FfiConverterString.lift
...
export function verifyCircomProof(
  ...
  return FfiConverterBool.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_mithras_mobile_fn_func_verify_circom_proof(
          FfiConverterString.lower(zkeyPath),
...
export function verifyHalo2Proof(
  ...
  return FfiConverterBool.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_mithras_mobile_fn_func_verify_halo2_proof(
          FfiConverterString.lower(srsPath),
...
export function verifyNoirProof(
  ...
  return FfiConverterBool.lift(
    uniffiCaller.rustCallWithError(
      ...
      /*caller:*/ (callStatus) => {
        return nativeModule().ubrn_uniffi_mithras_mobile_fn_func_verify_noir_proof(
          FfiConverterString.lower(circuitPath),
          FfiConverterArrayBuffer.lower(proof),
          FfiConverterBool.lower(onChain),
          FfiConverterArrayBuffer.lower(vk),
...
export const CircomProof = (() => {
  ...
  return Object.freeze({
     ...
     * in Rust, in the {@link mithras_mobile} crate.
     */
    create,
    ...
    /**
     * Defaults specified in the {@link mithras_mobile} crate.
     */
...
function uniffiEnsureInitialized() {
  ...
  const scaffoldingContractVersion =
    nativeModule().ubrn_ffi_mithras_mobile_uniffi_contract_version();
  ...
  if (
    nativeModule().ubrn_uniffi_mithras_mobile_checksum_func_generate_circom_proof() !==
    9
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_mithras_mobile_checksum_func_generate_circom_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_mithras_mobile_checksum_func_generate_halo2_proof() !==
    42951
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_mithras_mobile_checksum_func_generate_halo2_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_mithras_mobile_checksum_func_generate_noir_proof() !==
    7669
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_mithras_mobile_checksum_func_generate_noir_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_mithras_mobile_checksum_func_get_noir_verification_key() !==
    40218
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_mithras_mobile_checksum_func_get_noir_verification_key'
    );
  }
  if (
    nativeModule().ubrn_uniffi_mithras_mobile_checksum_func_mopro_hello_world() !==
    53466
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_mithras_mobile_checksum_func_mopro_hello_world'
    );
  }
  if (
    nativeModule().ubrn_uniffi_mithras_mobile_checksum_func_verify_circom_proof() !==
    2078
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_mithras_mobile_checksum_func_verify_circom_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_mithras_mobile_checksum_func_verify_halo2_proof() !==
    15731
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_mithras_mobile_checksum_func_verify_halo2_proof'
    );
  }
  if (
    nativeModule().ubrn_uniffi_mithras_mobile_checksum_func_verify_noir_proof() !==
    22277
  ) {
    throw new UniffiInternalError.ApiChecksumMismatch(
      'uniffi_mithras_mobile_checksum_func_verify_noir_proof'
    );
  }
}
